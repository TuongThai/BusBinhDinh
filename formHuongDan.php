            ...
            <div class="content-intro">
                ...
                <a class="item-intro" href="formHuongDanTongQuan.php">
                    <div class="des-intro">
                        ...
                        <div class="desc">
                            <p>Các hướng dẫn tổng quan về ứng dụng bao gồm đăng nhập, cài đặt khu vực sẽ giúp bạn có trải nghiệm tốt nhất cùng ứng dụng tại thành phố bạn đang sống.</p>
                        </div>
                    </div>
                </a>
            </div>
