		...
		<div class="recentOrders">
			...
			<table>
				...
				if(isset($_SESSION['dn'])){
					...
					$sotrangdl = 0;
					//Xác đinh số dòng (tin) trên một trang
					$sodong = 25;
					...
					if( !isset($_POST["tram"]) && !isset($_POST["del"]) && !isset($_POST["update"]))	
					{
						...
						while($row = mysqli_fetch_array($kqpt)) //Lấy mỗi dòng của dữ liệu thông qua $kqpt
						{
